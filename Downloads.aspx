				...
				<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
					<nav class="cl-effect-1" id="cl-effect-1">
						<ul class="nav navbar-nav">
							...
							<li class="active"><a href="Downloads.aspx" class="hvr-bounce-to-bottom">Download</a></li>
...
<!-- mail -->
	<div class="mail">
		<div class="container">
			...
			<div id="text_content">
                <font size="4px">
			<h1><font color="#F58703">Downloads</font></h1>
				<br />

				<ul>

					<li>
					<p><font size="4px">Guidelines for Participating Team <a href="downloads/Guidelines for teams.pdf" target="_blank"><font size="5px" color="F58703">GuideLines</font></a></font></p>
					</li>
				<br />
				

					<li>
					<p><font size="4px">The Registration rules for the event EGVC-2017 are available over here <a href="downloads/Registration rules.pdf" target="_blank"><font size="5px" color="F58703">Registration Rule</font></a></font></p>
					</li>
				<br />

					<li>
					<p><font size="4px">Technical RuleBook for the event EGVC-2017 is available over here<a href="downloads/TECHNICAL.pdf" target="_blank"><font size="5px" color="F58703">Technical RuleBook</font></a></font></p>
					</li>
				<br />
